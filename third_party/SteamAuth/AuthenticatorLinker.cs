...
namespace SteamAuth
{
    ...
    public class AuthenticatorLinker
    {
        ...
        /// <summary>
        /// Resume finalization of an authenticator whose pending data was already saved.
        /// </summary>
        public AuthenticatorLinker(SessionData sessionData, SteamGuardAccount linkedAccount)
        {
            this.Session = sessionData ?? throw new ArgumentNullException(nameof(sessionData));
            this.LinkedAccount = linkedAccount ?? throw new ArgumentNullException(nameof(linkedAccount));
            this.DeviceID = string.IsNullOrEmpty(linkedAccount.DeviceID) ? GenerateDeviceID() : linkedAccount.DeviceID;
            this.Finalized = linkedAccount.FullyEnrolled;
        }
